...
export const images = () => {
    return app.gulp
        ...
        .pipe(app.gulp.src(app.path.src.images, { encoding: false })) // знову отримуємо доступ до ісходніків
        .pipe(
            app.plugins.if(
                app.isBuild,
        ...
        .pipe(app.gulp.src(app.path.src.svg, { encoding: false })) // вибрати svg
